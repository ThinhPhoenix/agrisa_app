...
/**
 * Screen quét CCCD với guard kiểm tra profile đầy đủ
 * - Bắt buộc phải có thông tin cá nhân đầy đủ trước khi quét CCCD
...
export default function IdScanScreen() {
  ...
  useEffect(() => {
    if (!isChecking && !isLoading && profileData) {
      ...
      if (!profileComplete) {
        ...
        Alert.alert(
          "Cập nhật thông tin cá nhân",
          `Vui lòng hoàn thiện thông tin cá nhân để tiếp tục xác thực CCCD.\n\nCần bổ sung: ${missingFields.join(", ")}`,
          [
            {
              text: "Cập nhật ngay",
    ...
    return (
      ...
      >
        ...
        <Text
          ...
          mb="$3"
        >
          Trước khi xác thực CCCD, vui lòng cập nhật đầy đủ thông tin cá nhân
          của bạn.
        </Text>
  ...
  // Profile đầy đủ, cho phép quét CCCD
  return (
    <>
      <OCRIdScreen />
    </>
