...
export const RegisterFarmForm: React.FC<RegisterFarmFormProps> = ({
  ...
  const formFields: FormField[] = [
    ...
    // Section 2: Địa chỉ (auto-fill từ OCR trong Create mode)
    {
      ...
      placeholder: mode === 'create' ? 'Tự động điền từ sổ đỏ' : 'Nhập tỉnh/thành phố',
      type: 'input',
      required: true,
    ...
    },
    {
      name: 'district',
      label: 'Quận/Huyện',
      placeholder: mode === 'create' ? 'Tự động điền từ sổ đỏ' : 'Nhập quận/huyện',
      type: 'input',
      required: true,
      disabled: mode === 'create' && !ocrResult,
    },
    {
      name: 'commune',
      label: 'Phường/Xã',
      placeholder: mode === 'create' ? 'Tự động điền từ sổ đỏ' : 'Nhập phường/xã',
      type: 'input',
      required: true,
      disabled: mode === 'create' && !ocrResult,
    },
    {
      ...
      placeholder: mode === 'create' ? 'Tự động điền từ sổ đỏ' : 'Nhập địa chỉ chi tiết',
      type: 'textarea',
      required: true,
      disabled: mode === 'create' && !ocrResult,
    },
    ...
    },
    {
      name: 'area_sqm',
      label: 'Diện tích (m²)',
      placeholder: mode === 'create' ? 'Tự động điền từ sổ đỏ' : 'Nhập diện tích',
      type: 'number',
      required: true,
      disabled: mode === 'create' && !ocrResult,
      helperText: mode === 'create' ? 'Diện tích được lấy từ sổ đỏ' : 'Đơn vị: mét vuông (m²)',
    },
    {
      name: 'planting_date',
    ...
    // Section 4: Thông tin đất đai
    {
      ...
      label: 'Số sổ đỏ',
      placeholder: mode === 'create' ? 'Tự động điền từ sổ đỏ' : 'Nhập số sổ đỏ',
      type: 'input',
      required: true,
      disabled: mode === 'create' && !ocrResult,
