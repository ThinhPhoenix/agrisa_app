 ...
 * Chuyên dụng cho trang "Hợp đồng của tôi"
 */
export const ActivePolicyCard: React.FC<ActivePolicyCardProps> = ({
        ...
        switch (policy.status) {
            ...
            case RegisteredPolicyStatus.DISPUTE:
                return {
                    ...
                    showDays: false,
                    message:
                        "Hợp đồng đang trong quá trình giải quyết tranh chấp",
                };
            ...
            case RegisteredPolicyStatus.ACTIVE:
                ...
                const daysLeft = Math.ceil(
                    (policy.coverage_end_date - now) / 86400
                );
                return {
                    label: "Có hiệu lực",
    ...
    return (
        <Pressable
            onPress={() =>
                router.push(`/(farmer)/registered-policies/${policy.id}`)
            }
        >
            {({ pressed }) => (
                <Box
